...
export class AppComponent implements OnDestroy, OnInit, AfterViewInit {
  ...
  userOperationRecords: Map<number, { week: number, amount: number }> = new Map<number, { week: number; amount: number }>();
  ...
  resetUserRecord(operation: Operation) {
    this.userOperationRecords.set(operation.user_id, {week: moment().week(), amount: 0})
  }
